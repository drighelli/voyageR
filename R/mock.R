#' Generate a mock SpatialExperiment including spatially variable genes.
#'
#' Implementation based on [trendsceek::add_markdist_step()].
#'
#' @param tot_genes Total number of gene profiles to be generated.
#' @param de_genes Number of spatially variable genes.
#' @param lambda Expected number of spots over which genes are sampled.
#'
